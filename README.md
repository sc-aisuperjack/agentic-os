...
- **⚡ The Nginx Gateway:** The bouncer of the mesh. Handles routing, rate limiting (10r/s), and secure transparent handoffs to internal services.
- **🧠 The Central Orchestrator:** The "Brain" of the OS. Uses a compiled LangGraph engine to dynamically discover agents and route tasks based on "Capability Intelligence."
...
- **💾 Distributed Memory:** Powered by **Redis Stack** (Semantic Cache) and **MongoDB** (Persistence) to ensure the hive mind never forgets a winning strategy.
